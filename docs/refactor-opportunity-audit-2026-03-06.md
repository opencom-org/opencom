...
|---|---|---|---|
| 1 | Messenger/home-config contract convergence across Convex, web, widget, and RN | The public messenger/home view model is now shared through [`messengerSettings.ts`](/Users/jack/dev/Repos/opencom-prod/packages/types/src/messengerSettings.ts) and [`homeConfig.ts`](/Users/jack/dev/Repos/opencom-prod/packages/types/src/homeConfig.ts), and both widget and RN now consume those shared models. The remaining high-value work in this track is therefore narrower and clearer: [`messengerSettings.ts`](/Users/jack/dev/Repos/opencom-prod/packages/convex/convex/messengerSettings.ts) still mixes admin mutation logic, logo asset handling, audience rules, public shaping, and home-card CRUD, while [`MessengerSettingsSection.tsx`](/Users/jack/dev/Repos/opencom-prod/apps/web/src/app/settings/MessengerSettingsSection.tsx) is still a concentrated authoring surface. | `docs/refactor-progress-messenger-home-contract-convergence-2026-03-07.md`, `packages/convex/convex/messengerSettings.ts`, `apps/web/src/app/settings/MessengerSettingsSection.tsx` |
