...
- Remaining work in this track is authoring-side contract convergence in the web outbound editor and any residual trigger helper duplication that still sits outside `@opencom/types`.
