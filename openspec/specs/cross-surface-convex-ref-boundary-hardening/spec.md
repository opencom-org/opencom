# cross-surface-convex-ref-boundary-hardening Specification

## Purpose
TBD - created by archiving change close-repo-wide-convex-ref-hardening-gaps. Update Purpose after archive.
## Requirements
