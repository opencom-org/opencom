...
- [ ] make AI more chatty/sociable/less robotic,able to answer generic greetings etc. more naturally like a human support person would.
- [ ] fix double send (debounce AI responses - queue messages?)
